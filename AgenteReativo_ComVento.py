...
def get_perceptions(observation):
    ...
    target_treshold = 0.055 # permite a nave continuar a deslocar-se até uma margem de distancia
...
PRINCIPAL = np.array([1,0]) # esta ação liga o motor principal
ESQUERDA = np.array([1,-1]) # esta ação liga o motor direito e o principal, permitindo rodar para a esquerda
DIREITA = np.array([1,1]) # esta ação liga o motor esquerdo e o principal, permitindo rodar para a direita
